import { renderHeader } from "./components/header.js?v=20260921_v78";
import { renderFooter } from "./components/footer.js?v=20260921_v78";
import { renderCalendar } from "./components/calendar.js?v=20260921_v78";
import { renderPrograms } from "./components/programs.js?v=20260921_v78";
import { renderReviews } from "./components/reviews.js?v=20260921_v78";
import { renderPadletRooms } from "./components/padletRooms.js?v=20260921_v78";
import { openEventFormModal } from "./components/eventFormModal.js?v=20260921_v78";
import { GoogleAuthService } from "./auth/googleAuth.js?v=20260921_v78";
import { isEventPastOrToday, resolveApplyLink } from "./data/events.js?v=20260921_v78";
