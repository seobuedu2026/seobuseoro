      ...
      <div class="m3-modal-dialog" style="max-width: 440px;">
        ...
        <form id="admin-auth-form" style="margin-top: 6px;">
          <div class="form-group" style="margin-bottom: 14px;">
            ...
            <input type="email" id="admin-email-input" class="m3-input" placeholder="seobuedu2026@gmail.com" value="${defaultEmail || 'seobuedu2026@gmail.com'}" autofocus required autocomplete="off" style="padding:11px 12px; font-size:15px;" />
          </div>
